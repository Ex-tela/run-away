...
export default function RootLayout({children,}: Readonly<{
  ...
  return (
      <html lang="en" className="bg-stone-100 dark:bg-stone-700">
      <head>
      </head>
      ...
      <Navbar className="text-stone-800 dark:text-stone-300 bg-stone-200 dark:bg-stone-800">
        ...
        <div className="inline-flex flex-grow pl-20 pr-20">
          <input className="w-full bg-stone-100 dark:bg-stone-700 rounded-3xl p-2 pl-4 pr-4 mr-2 focus:border-none"
        ...
        <button>
          <TbSunMoon
              className="mr-6 w-10 h-10 hover:bg-stone-100 dark:hover:bg-stone-700 rounded-2xl p-2"/>
        </button>
        ...
        <div className="w-full bg-stone-200 dark:bg-stone-800 rounded-lg">
          ...
          <div
            ...
            <div className="mt-4 flex space-x-6 sm:mt-0 sm:justify-center">
              <FooterIcon icon={FaGithub} className="text-stone-600 dark:text-stone-400 h-6 w-6"
                          href="https://github.com/Ex-tela/run-away-fashion"/>
              <FooterIcon icon={FaLinkedin} className="text-stone-600 dark:text-stone-400 h-6 w-6"
